$(document).ready(function() {
  ...
  $('#id_username').attr('placeholder', 'Ej: elleshuga, maritnin, jasiel3');
  $('#id_first_name').attr('placeholder', 'Ej: Moises, Denisse, Javiera');
  $('#id_last_name').attr('placeholder', 'Ej: Sanchez, Coilla, Linares');
  $('#id_email').attr('placeholder', 'Ej: mo.sanchez@duocuc.cl');
